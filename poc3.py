...
def runPipeline(dir_train, dir_test, left, right, mlModel, featureExtraction, applyPca):
    ...
    joblib.dump(mlModel, 'svm_model.pkl')  # Save
...
if __name__ == '__main__':
    ...
    #DIR_TRAIN = "D:\\Speech Processing\\project\\securimage_all\\train"
    #DIR_TEST = "D:\\Speech Processing\\project\\securimage_all\\test"
    LEFT = 2500
    RIGHT = 2500
    MLMODEL = SVM()
